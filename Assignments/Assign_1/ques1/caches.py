...
class L1ICache(L1Cache):
    ...
    def __init__(self, opts=None):
        ...
        print(f"L1I Cache Size from Options: {opts.l1i_size}")
...
class L1DCache(L1Cache):
    ...
    def __init__(self, opts=None):
        ...
        print(f"L1D Cache Size from Options: {opts.l1d_size}")
...
class L2Cache(Cache):
    ...
    SimpleOpts.add_option("--l2_assoc", help=f"L2 assoc size. Default: {assoc}")

    def __init__(self, opts=None):
        super(L2Cache, self).__init__()
        print(f"L2 Cache Size from Options: {opts.l2_size}")
